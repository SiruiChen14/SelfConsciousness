...
Usage: 
python merge.py \
    --base_model path/to/original-hf-model \
    --lora_model path/to/finetuned-model \
...
parser = argparse.ArgumentParser(description='Script to merge original hf model with Finetuned LoRA weights')
parser.add_argument('--base_model', default=None, required=True,
                    type=str, help="Base model path")
